...
For the training set, there are 3620 records with missing values. The attributes
that contain missing values are: \textbf{Workclass}, \textbf{Occupation} and 
\textbf{Native-country}.

This data set is available in the following URL: \url{ftp://ftp.ics.uci.edu/pub/machine-learning-databases/adult}.

\subsection{Data Analysis}

The table \ref{tab:summary} summarizes the distribution of values in the training data on the studied
dataset, while the table \ref{tab:summarytest} summarizes the same distribution but
for the test set. A quick observation shows that the distribution of values is 
similar in both the training and the test set. Taking that into account, some
analysis was conducted on the training data, expecting some interesting 
properties to arise. From a first observation, one can see that the amount of missing values
...
list of rules and the other for an unordered one.
...
Around 7000 clauses were built, taking around 5 hours for the whole training
...
\caption{Summary of the value distribution on the training data of the dataset}
\label{tab:summary}
\end{table}
...
\subtable[Marital Status]{        
       ...
       divorced & 2190 \\
       \hline
       married\_af\_spouse & 14 \\
       \hline
       married\_civ\_spouse & 7403 \\
       \hline
       married\_spouse\_absent & 210 \\
       \hline
       never\_married & 5434 \\
       \hline
       separated & 505 \\
...
\subtable[Occupation]{        
       \begin{tabular}{| l | l |}
       \hline
       prof\_specialty & 2032 \\
       \hline
       exec\_managerial & 2020 \\
       \hline
       craft\_repair & 2013 \\
       \hline
       sales & 1854 \\
...
\subtable[Race]{        
       \begin{tabular}{| l | l |}
       \hline
       amer\_indian\_eskimo & 159 \\
       \hline
       asian\_pac\_islander & 480 \\
       \hline
       black & 1561 \\
       \hline
       other & 135 \\
...
\caption{Summary of the value distribution on the test data of the dataset}
\label{tab:summarytest}
\end{table}
