...
belonging to a pre-defined class. The ultimate goal is to learn a concept. This
...
The algorithms we will be using are: ID3, C4.5, CN2 and AQ. Depending on our progress
