...
is put under one class and not in another, that is, we want to understand what social characteristics
...
K-Means method was used to obtain the final clusters, with a k of 6. Figures 
\ref{fig:cluster_1_age_education} and \ref{fig:cluster_1_education_hpw} show
...
50K. Notice, as stated before, that this were the cluster having people with
lower education and younger age, respective.
