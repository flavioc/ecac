...
public class Utils {
	...
	public static Instances prepareData(String sql, String user, String password) throws Exception {
	...
	public static Instances getTrainSet(String user, String password) throws Exception
	{
		return prepareData(TRAIN_QUERY, user, password);
	}
	
	public static Instances getTestSet(String user, String password) throws Exception
	{
		return prepareData(TEST_QUERY, user, password);
	}
}
